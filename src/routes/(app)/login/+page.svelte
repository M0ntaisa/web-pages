  ...
  <div class="form h-screen flex flex-col justify-center items-center">
    <form class="bg-gray-100 rounded-lg px-8 pt-6 pb-8 mb-4" method="POST">
      ...
      <div class="mb-4">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" name="username" type="text" placeholder="example123" value={form?.username || ""}>
      </div>
      <div class="mb-4">
      ...
      <div class="flex items-center justify-between">
        <Button id="action">Sign In</Button>
      </div>
    </form>
  </div>
